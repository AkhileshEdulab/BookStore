...
const [authUser,setAuthUser]=useAuth()
  ...
  return (
   ...
   <div className="navbar-start ">
    <div className="dropdown ">
      ...
      <ul
        tabIndex={0}
        className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow font-bold dark:bg-slate-900 dark:text-white ">
        {navItems}
      </ul>
    </div>
  ...
  <div className="navbar-center hidden lg:flex space-x-4 ">
    <ul className="menu menu-horizontal px-1 font-bold dark:bg-slate-900 dark:text-white" >
     {navItems}
    </ul>
  ...
  <svg
  ...
  </div>
    {
      ...
      <a className="btn btn-outline  btn-accent text-white px-3 py-2 rounded-md hover:bg-slate-700 duration-300 cursor-pointer " 
